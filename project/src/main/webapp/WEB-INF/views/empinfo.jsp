...
<html lang="ko">
	...
	//////// select / radio에 값 뿌려주기
		...
		if( "${empBasicinfo.EMP_STTS_CODE}" == null || "${empBasicinfo.EMP_STTS_CODE}" == "") {
			...
			$("option[class='${empBasicinfo.EMP_STTS_CODE}']").attr("selected","selected");
		}
		...
		if( "${empBasicinfo.DPT_ROLE_CLS_CODE}" == null || "${empBasicinfo.DPT_ROLE_CLS_CODE}" == "") {
			...
			$("option[class='${empBasicinfo.DPT_ROLE_CLS_CODE}']").attr("selected","selected");
		}
		
		//직급
		if( "${empBasicinfo.RNK_CODE}" == null || "${empBasicinfo.RNK_CODE}" == "") {
			//$("option[class='default']").attr("selected","selected");
		} else {
			$("option[class='${empBasicinfo.RNK_CODE}']").attr("selected","selected");
		}
		//성별
	...
	////////////경력정보			
		...
		function searchdpt(){		
			var id = "";
			//alert("${first_check}");
			//if("${first_check}" == "new") id = "new";
			//else id = ${empBasicinfo.EMP_NO};
			var url='/empinfo/dpt?emp_no='+$('input[name="EMP_NO"]').val();
							    ...
							    <tbody id="edu-tr">			
								     ...
								     <c:forEach var="edu" items="${empEducationinfo}">		
										...
										<td>${edu.EMP_ACCR_NO}</td>
										    ...
										    <td>	
												<input type='text' class='edutext'  value='${edu.GRAD_VAL01}' name='GRAD_VAL01'>	
													&nbsp;&nbsp; / &nbsp;&nbsp;
												<input type='text' class='edutext'  value='${edu.GRAD_VAL02}' name='GRAD_VAL02'>				    
										    </td>		
										    <td>
								     	...
								     	<c:forEach begin="${num}" end="${4}">
									     	...
									     	<td>${max}</td>
											    <td>
													...
													<input type="hidden" name='EMP_ACCR_NO' value="${max}">					    
											    </td>
											    <td>
										    ...
										    <td>
											    ...
											    <td>
													...
													&nbsp;&nbsp; / &nbsp;&nbsp;
													<input type='text' class='edutext'  value='' name='GRAD_VAL02'>					    
											    </td>		
											    <td>
								     	...
								     	<c:forEach begin="${work_num}" end="4">
								     		...
								     		<td>${work_max}</td>					     	
										     	<td>
													...
													<input type="hidden" name='EMP_CARR_NO' value="${work_max}">			    
											    </td>
											    <td>
